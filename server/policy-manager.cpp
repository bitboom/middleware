...
std::unordered_map<std::string, ManagedPolicy> managedPolicyMap = {
	DEFINE_USER_POLICY("password-history", 0, MaximizeIntegerComparator),
	DEFINE_USER_POLICY("password-minimum-length", 0, MaximizeIntegerComparator),
    DEFINE_USER_POLICY("password-minimum-complexity", 0, MaximizeIntegerComparator),
    DEFINE_USER_POLICY("password-inactivity-timeout", 1000, MaximizeIntegerComparator),
    DEFINE_USER_POLICY("password-expired",0, MinimizeIntegerComparator),
    DEFINE_USER_POLICY("password-maximum-failure-count", 0, MinimizeIntegerComparator),
    DEFINE_USER_POLICY("password-numeric-sequences-length", 0, MinimizeIntegerComparator),
	DEFINE_USER_POLICY("password-maximum-character-occurrences", 0, MinimizeIntegerComparator),
	DEFINE_USER_POLICY("password-quality", 0, MaximizeIntegerComparator),
